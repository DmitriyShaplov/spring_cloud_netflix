...
import ru.example.movieservice.exception.MovieNotFoundException;
import ru.example.movieservice.model.Movie;
import ru.example.movieservice.payload.ErrorResponse;
...
public class MovieController {
    ...
    public ResponseEntity<Void> handleBucketNotFoundException(MovieNotFoundException ex) {
